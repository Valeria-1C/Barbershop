...
Процедура ЗаполнитьПланировщикНаСервере()
	...
	|	ЗаписьКлиента.Сотрудники.Представление КАК СотрудникиПредставление,
	...
	|	ЗаписьКлиента.Клиент.Ссылка КАК ЗаписьКлиента,
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		НовоеИзмерение = ИзмерениеСотрудники.Элементы.Добавить(ВыборкаСотрудники.Сотрудники);
		НовоеИзмерение.Текст = ВыборкаСотрудники.СотрудникиПредставление;
		...
		Пока Выборка.Следующий() Цикл
			...
			СоответствиеЗначений.Вставить("Сотрудники", Выборка.Сотрудники);
...
Процедура ПланировщикПередСозданием(Элемент, Начало, Конец, ЗначенияИзмерений, Текст, СтандартнаяОбработка)
	...
	ПараметрыОткрытияФормы = Новый Структура("Начало, Окончание, Сотрудник", Начало, Конец, ЗначенияИзмерений.Получить("Сотрудник"));
